...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Encounter">
      <sch:assert test="count(f:extension[@url = 'http://fhir.kl.dk/ltt/StructureDefinition/klgateway-ltt-encounter-delivery-type']) &lt;= 1">extension with URL = 'http://fhir.kl.dk/ltt/StructureDefinition/klgateway-ltt-encounter-delivery-type': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.kl.dk/ltt/StructureDefinition/klgateway-ltt-encounter-based-on-care-plan']) &gt;= 1">extension with URL = 'http://fhir.kl.dk/ltt/StructureDefinition/klgateway-ltt-encounter-based-on-care-plan': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.kl.dk/ltt/StructureDefinition/klgateway-ltt-encounter-based-on-care-plan']) &lt;= 1">extension with URL = 'http://fhir.kl.dk/ltt/StructureDefinition/klgateway-ltt-encounter-based-on-care-plan': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Encounter/f:extension/f:value[x] 1</sch:title>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Encounter/f:participant">
      ...
      <sch:assert test="count(f:individual) &lt;= 0">individual: maximum cardinality of 'individual' is 0</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    ...
    <sch:rule context="f:Encounter/f:period">
      ...
      <sch:assert test="count(f:end) &lt;= 0">end: maximum cardinality of 'end' is 0</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
