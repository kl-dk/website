# DeliveryReport-Josefine-4 - LTT Implementation Guide v1.0.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **DeliveryReport-Josefine-4**

## Example Bundle: DeliveryReport-Josefine-4

Profile: [KLGatewayLTTDeliveryReport](StructureDefinition-klgateway-ltt-delivery-report.md)

Bundle DeliveryReport-Josefine-4 of type collection
...
**status**: Active**intent**: Plan**subject**:[Anonymous Patient (no stated gender), DoB Unknown ( urn:oid:1.2.208.176.1.2#0505149996 (use: official, ))](Bundle-DeliveryReport-Josefine-1.md#Patient_407ceb16-acb4-43ea-a4f5-d415c17faded)**period**: 2025-05-14 09:12:05+0000 --> (ongoing)
> **activity**

-------

Entry 3 - fullUrl = https://test.fhir.dk/Encounter/1e301099-74bc-468b-8878-31839f201eb3
...
**BasedOnCarePlan**:[CarePlan: status = active; intent = plan; period = 2025-05-14 09:12:05+0000 --> (ongoing)](Bundle-DeliveryReport-Josefine-1.md#CarePlan_857ea1d6-c212-4c89-a2f4-9e2bfa8c288d)**DeliveryType**:Individuel indsats**status**: completed**class**:ambulatory**type**:Behandling**subject**:[Anonymous Patient (no stated gender), DoB Unknown ( urn:oid:1.2.208.176.1.2#0505149996 (use: official, ))](Bundle-DeliveryReport-Josefine-1.md#Patient_407ceb16-acb4-43ea-a4f5-d415c17faded)
...
Entry 4 - fullUrl = https://test.fhir.dk/CarePlan/fc350499-9e8d-4236-b4e2-4f9d47174b85
...
**basedOn**:[CarePlan: status = active; intent = plan; period = 2025-05-14 09:12:05+0000 --> (ongoing)](Bundle-DeliveryReport-Josefine-1.md#CarePlan_857ea1d6-c212-4c89-a2f4-9e2bfa8c288d)**status**: Completed**intent**: Plan**subject**:[Anonymous Patient (no stated gender), DoB Unknown ( urn:oid:1.2.208.176.1.2#0505149996 (use: official, ))](Bundle-DeliveryReport-Josefine-1.md#Patient_407ceb16-acb4-43ea-a4f5-d415c17faded)**period**: 2025-07-07 14:28:17+0000 --> (ongoing)
> **activity**
...
```json
{
  ...
  "entry" : [
    ...
    {
      "fullUrl" : "https://test.fhir.dk/Encounter/1e301099-74bc-468b-8878-31839f201eb3",
      "resource" : {
        "resourceType" : "Encounter",
        "id" : "1e301099-74bc-468b-8878-31839f201eb3",
        "meta" : {
          "profile" : [
    ...
    {
      "fullUrl" : "https://test.fhir.dk/CarePlan/fc350499-9e8d-4236-b4e2-4f9d47174b85",
      "resource" : {
        "resourceType" : "CarePlan",
        "id" : "fc350499-9e8d-4236-b4e2-4f9d47174b85",
        "meta" : {
          "profile" : [
        ...
        "text" : {
          "status" : "generated",
          "div" : "<div xmlns=\"http://www.w3.org/1999/xhtml\"><a name=\"CarePlan_fc350499-9e8d-4236-b4e2-4f9d47174b85\"> </a><p class=\"res-header-id\"><b>Generated Narrative: CarePlan fc350499-9e8d-4236-b4e2-4f9d47174b85</b></p><a name=\"fc350499-9e8d-4236-b4e2-4f9d47174b85\"> </a><a name=\"hcfc350499-9e8d-4236-b4e2-4f9d47174b85\"> </a><div style=\"display: inline-block; background-color: #d9e0e7; padding: 6px; margin: 4px; border: 1px solid #8da1b4; border-radius: 5px; line-height: 60%\"><p style=\"margin-bottom: 0px\"/><p style=\"margin-bottom: 0px\">Profile: <a href=\"StructureDefinition-klgateway-ltt-referral.html\">KLGatewayLTTReferral</a></p></div><p><b>basedOn</b>: <a href=\"Bundle-DeliveryReport-Josefine-1.html#CarePlan_857ea1d6-c212-4c89-a2f4-9e2bfa8c288d\">CarePlan: status = active; intent = plan; period = 2025-05-14 09:12:05+0000 --&gt; (ongoing)</a></p><p><b>status</b>: Completed</p><p><b>intent</b>: Plan</p><p><b>subject</b>: <a href=\"Bundle-DeliveryReport-Josefine-1.html#Patient_407ceb16-acb4-43ea-a4f5-d415c17faded\">Anonymous Patient (no stated gender), DoB Unknown ( urn:oid:1.2.208.176.1.2#0505149996 (use: official, ))</a></p><p><b>period</b>: 2025-07-07 14:28:17+0000 --&gt; (ongoing)</p><blockquote><p><b>activity</b></p><h3>Details</h3><table class=\"grid\"><tr><td style=\"display: none\">-</td><td><b>Code</b></td><td><b>Status</b></td></tr><tr><td style=\"display: none\">*</td><td><span title=\"Codes:{http://fhir.kl.dk/term/CodeSystem/LTT f3d5cb7b-e059-4fbc-9514-a53299c2e3cf}\">Civilsamfund</span></td><td>Completed</td></tr></table></blockquote></div>"
        },
        "basedOn" : [
          {
            "reference" : "CarePlan/857ea1d6-c212-4c89-a2f4-9e2bfa8c288d"
