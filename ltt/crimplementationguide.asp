...
<%
  ...
  if (s.indexOf("application/json+fhir") > -1) 
    ...
    Response.Redirect("http://fhir.kl.dk/ltt/1.0.1/index.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from ltt#1.0.1-milestone\output\crimplementationguide.asp) .
</body>
</html>
