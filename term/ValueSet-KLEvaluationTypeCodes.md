# KLVurderingTypekoder - KL Terminologi v2.4.0
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.kl.dk/term/ValueSet/KLEvaluationTypeCodes | *Version*:2.4.0 |
| Active as of 2026-04-21 | *Computable Name*:KLEvaluationTypeCodes |
...
```json
{
  ...
  "id" : "KLEvaluationTypeCodes",
  "url" : "http://fhir.kl.dk/term/ValueSet/KLEvaluationTypeCodes",
  "version" : "2.4.0",
  "name" : "KLEvaluationTypeCodes",
  ...
  "compose" : {
    "include" : [{
      ...
      "filter" : [{
        "property" : "concept",
        "op" : "descendent-of",
        "value" : "95ec4535-8fe8-4296-867c-35de421794cf"
      }]
    }]
  }
}
