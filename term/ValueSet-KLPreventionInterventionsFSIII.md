# KLForebyggelseIndsatserFSIII - KL Terminologi v2.4.0
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.kl.dk/term/ValueSet/KLPreventionInterventionsFSIII | *Version*:2.4.0 |
| Active as of 2026-04-21 | *Computable Name*:KLPreventionInterventionsFSIII |
...
```json
{
  ...
  "id" : "KLPreventionInterventionsFSIII",
  "url" : "http://fhir.kl.dk/term/ValueSet/KLPreventionInterventionsFSIII",
  "version" : "2.4.0",
  "name" : "KLPreventionInterventionsFSIII",
  ...
  "compose" : {
    "include" : [{
      ...
      "filter" : [{
        "property" : "concept",
        "op" : "descendent-of",
        "value" : "102ea764-d2cf-4a24-979d-68c2e8d638cf"
      }]
    }]
  }
}
